...
<head>
  ...
  <script src="app/formularios/FormUnidadAcademica/FormUnidad_entidad.js"></script>
...
<body>
 ...
 <div class="col-md-12">   
     ...
     <section class="content-header">
        <button type="submit" class="btn btn-success btn-ls" data-toggle="modal" data-target="#agregarEntidadUnidad" align="right" >
            Entidad U-Academica
        </button>
   </section><br><br>
...
-->
       ...
       <!--Formulario para agregar y editar-->      
        <div id="agregarEntidadUnidad" class="modal fade" role="dialog">
                <div class="modal-dialog">

                    <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Entidad de U-Academica</h4>
                    </div>
                ...
                <label>Entidades</label>
                  ...
                  <br>
                <label>Unidades Academicas</label>
                  <select class="form-control" id="unidadesAcademicas">
                    <option value="0">Seleccione</option>
                  </select>
                  <br>
                  <div class="box-footer" id="respuesta">
                      ...
                      <div class="box-footer">
                            <button type="button" class="btn btn-primary" id="guardarUnidadEntidad">Guardar</button>
                        </div>
                 </form>
                </div>
