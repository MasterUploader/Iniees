...
<head>
	...
	<script src="app/formularios/FormEntPatrocinadora/FormEntPatrocinadora.js"></script>
</head>
...
<body>
 ...
 <div class="col-md-12">   
     ...
     <section class="content-header">
        <button type="submit" class="btn btn-success btn-ls" data-toggle="modal" data-target="#agregarPatrocinador" align="right" >
        	  Nueva Entidad Patrocinadora
        </button>
	 </section><br><br>
	 <!-- Tabla que muestra las entidades registradas -->
       ...
       <!--Formulario para agregar y editar-->      
        <div id="agregarPatrocinador" class="modal fade" role="dialog">
                <div class="modal-dialog">

                    <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Agregar Entidad Patrocinadora</h4>
                    </div>
                    <div class="modal-body">
                        <form role="form">
                                ...
                                <div class="box-footer">
                                    <button type="button" class="btn btn-primary" id="guardarEntPatrocinadora">Guardar</button>
                                </div>
                         </form>
                    </div>
